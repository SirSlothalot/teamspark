...
function getState()
{
  var s_a = new Array();
    ...
    // var countrySel = parseInt(document.getElementById("country").value);
    //document.getElementById("emailError").innerHTML = strCountry;
    var countryId = countryList.indexOf(strCountry);
    //document.getElementById("emailError").innerHTML = String(countryId);
    //
    var stateString = s_a[countryId+1];
    var stateList = stateString.split('|');
    //document.getElementById("emailError").innerHTML = String(stateList[1]);
    var stateOpt = document.getElementById("state");

    while (stateOpt.firstChild) {
      stateOpt.removeChild(stateOpt.firstChild);
    }
